...
- **~~API Strategy~~** — ✅ Published as `wikimedia-api-strategy`. Covers decision framework for all 6 access methods, task-specific decision trees, anti-pattern catalog, and performance comparisons. Ships with interactive CLI and importable Python module.
