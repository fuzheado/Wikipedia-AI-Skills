...
> **Most language editions of Wikipedia and other Wikimedia projects have community policies that restrict or ban the direct posting of content generated by large language models (LLMs).** This includes articles, sections, discussion comments, or any other substantial prose drafted by AI assistants, as well as images and other media files, whether uploaded to Wikimedia Commons or directly to a single Wikipedia edition. Before using AI to generate content, you **must** consult all relevant AI policies. These are summarised on Meta-Wiki at [AI policies by project &sect; Discussions](https://meta.wikimedia.org/wiki/Artificial_intelligence/Policies_by_project#Discussions). You must read the full policies and guidelines, not just the summaries.
> 
> **Do not copy-paste AI-generated text directly into Wikipedia talk pages.** Some Wikipedias routinely collapse ("hat") or remove any AI-generated comments and exclude them from assessments of consensus.
