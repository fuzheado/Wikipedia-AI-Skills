...
| **"Report status and priority fields … reflect reality and do not cause it"**, and **don't assign a task to someone without their prior agreement** — comment with your case instead | Phabricator etiquette |
| **Etiquette basics**: act in public, search before filing, one issue per task, no "me too" — subscribe or mention instead; use `@usernames`, not real names | Phabricator etiquette |
