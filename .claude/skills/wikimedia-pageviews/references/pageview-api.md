...
> exists: `all-agents` = `user` + `spider` exactly, re-verified 2026-09-15); automated clients'
> image requests are UA-counted as `user`** — pair media-user with pageviews(user+automated) for ratios.
